...
coef_species_flipper_length <- coef_flipper_length_mean +
  coef_flipper_length_sd * coef_species_flipper_length_raw
...
coef_species_body_mass <- coef_body_mass_mean +
  coef_body_mass_sd * coef_species_body_mass_raw
...
m <- model(
  intercept_mean,
  intercept_sd,
  coef_flipper_length_mean,
  coef_flipper_length_sd,
  coef_body_mass_mean,
  coef_body_mass_sd
)
